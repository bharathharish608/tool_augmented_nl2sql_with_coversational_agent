...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Tool-augmented NL2SQL agent. Provide a natural language query as an argument or via input.")
    ...
    # Step 1: IR generation (hardcoded 300s timeout)
    ir = agent.generate_ir(nl_query, ir_timeout=300)
    # Step 2: SQL pseudocode generation (if IR is valid)
